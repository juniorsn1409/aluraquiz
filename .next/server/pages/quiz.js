...
function QuizPage() {
  ...
  const question = _db_json__WEBPACK_IMPORTED_MODULE_1__.questions[questionIndex]; //[React chama de: Efeitos|| Effects] ciclo de estados!
  //React.useEffet
